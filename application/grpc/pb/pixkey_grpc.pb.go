...
const (
	PixService_RegisterPixKey_FullMethodName   = "/github.com.rcttavares.codepix.PixService/RegisterPixKey"
	PixService_Find_FullMethodName             = "/github.com.rcttavares.codepix.PixService/Find"
	PixService_DeactivatePixKey_FullMethodName = "/github.com.rcttavares.codepix.PixService/DeactivatePixKey"
)
...
type PixServiceClient interface {
	...
	DeactivatePixKey(ctx context.Context, in *PixKeyId, opts ...grpc.CallOption) (*PixKeyDeactivatedResult, error)
}
...
func (c *pixServiceClient) DeactivatePixKey(ctx context.Context, in *PixKeyId, opts ...grpc.CallOption) (*PixKeyDeactivatedResult, error) {
	out := new(PixKeyDeactivatedResult)
	err := c.cc.Invoke(ctx, PixService_DeactivatePixKey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PixServiceServer interface {
	...
	DeactivatePixKey(context.Context, *PixKeyId) (*PixKeyDeactivatedResult, error)
...
func (UnimplementedPixServiceServer) DeactivatePixKey(context.Context, *PixKeyId) (*PixKeyDeactivatedResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeactivatePixKey not implemented")
}
...
func _PixService_DeactivatePixKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PixKeyId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PixServiceServer).DeactivatePixKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PixService_DeactivatePixKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PixServiceServer).DeactivatePixKey(ctx, req.(*PixKeyId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PixService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.rcttavares.codepix.PixService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeactivatePixKey",
			Handler:    _PixService_DeactivatePixKey_Handler,
		},
	},
